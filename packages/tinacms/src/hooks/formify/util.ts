...
export const spliceLocation = (string: string, location: number[]) => {
...
export const setIn2 = (
  ...
  changes.forEach((change) => {
    meh = setIn(meh, change.path, change.value)
  })
  return meh
}

export const template = (query, events) => `
/**
Copyright 2021 Forestry.io Holdings, Inc.
Licensed under the Apache License, Version 2.0 (the "License");
you may not use this file except in compliance with the License.
...
export const getFormNodesStartingWith = (string: string, state: State) => {
