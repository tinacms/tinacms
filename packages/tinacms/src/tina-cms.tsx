...
/**
 * @deprecated Use `staticRequest` and a "try catch" block instead see https://tina.io/docs/features/data-fetching/#querying-tina-content-in-nextjs for more details
 *
