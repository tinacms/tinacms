...
const Header = ({ onClick, children }) => {
  return (
    <div className='pt-1 mb-5'>
      <button
        onClick={onClick}
        className='group px-4 py-3 bg-white hover:bg-gray-50 shadow focus:shadow-outline focus:border-tina-orange-dark w-full border border-gray-100 hover:border-gray-200 text-gray-500 hover:text-tina-orange focus:text-tina-orange-dark rounded flex justify-between items-center gap-2'
      >
