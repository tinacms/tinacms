...
var cms_react_1 = require("@forestryio/cms-react");
...
function useJsonForm(jsonNode, formOptions) {
    ...
    try {
        var cms_1 = cms_react_1.useCMS();
        var _a = cms_react_1.useCMSForm(__assign({ name: "markdownRemark:" + jsonNode.id, initialValues: jsonNode, fields: generateFields(jsonNode), onSubmit: function (data) {
...
function RemarkForm(_a) {
    var jsonNode = _a.jsonNode, render = _a.render, options = __rest(_a, ["jsonNode", "render"]);
    var _b = useJsonForm(jsonNode, options), data = _b[0], form = _b[1];
    return render({ form: form, data: data });
}
exports.RemarkForm = RemarkForm;
