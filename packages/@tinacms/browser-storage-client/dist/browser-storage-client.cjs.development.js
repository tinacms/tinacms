...
var useLocalStorageCache = function useLocalStorageCache(path, form, editMode) {
  ...
  var saveToStorage = react.useCallback(function (_formData) {
    cms.api.storage.save(path, flattenFormData(form.finalForm));
  }, [path]); // save to storage on change

  tinacms.useWatchFormValues(form, saveToStorage); // load from storage on boot
...
exports.BrowserStorageApi = BrowserStorageApi;
exports.flattenFormData = flattenFormData;
exports.useLocalStorageCache = useLocalStorageCache;
//# sourceMappingURL=browser-storage-client.cjs.development.js.map
