...
const config = {
  verbose: true,
  transform: {
    '.(ts|tsx)': '@strivemath/tinacms-scripts/dist/jest-runner.js',
    '.(js)': '@strivemath/tinacms-scripts/dist/jest-runner.js',
  },
  ...
  moduleNameMapper: {
    ...
    '\\.(css|less|scss|sass)$':
      '@strivemath/tinacms-scripts/__mocks__/styleMock.js',
  },
}
