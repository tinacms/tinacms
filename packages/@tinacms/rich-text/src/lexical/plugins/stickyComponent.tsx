...
import { exampleTheme } from '../editor'
import { $isStickyNode } from './stickyNode'

const StickyEditorTheme: EditorThemeClasses = {
  ...exampleTheme,
...
export default function StickyComponent({
  ...
  return (
    <div ref={stickyContainerRef} className="absolute w-48 inline-block">
      <div
        className={`w-20 p-4 relative ${color}`}
        onPointerDown={(event) => {
          const stickyContainer = stickyContainerRef.current
          if (
            stickyContainer == null ||
