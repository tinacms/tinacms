...
export const Menu = (props: Props) => {
  ...
  if (!editorView || !editorView.view) return null
  return (
    <ThemeProvider theme={theme}>
      <>
        ...
        >
          {supportBlocks && <FormattingDropdown editorView={editorView} />}
          <BoldControl editorView={editorView} />
          <ItalicControl editorView={editorView} />
          <UnderlineControl editorView={editorView} />
          <LinkControl editorView={editorView} />
          {/* <ImageControl view={view} bottom={bottom} /> */}
          {supportBlocks && (
            <TableControl editorView={editorView} bottom={bottom} />
          )}
          {supportBlocks && (
            <QuoteControl editorView={editorView} bottom={bottom} />
          )}
          {supportBlocks && (
            <CodeControl editorView={editorView} bottom={bottom} />
          )}
          {supportBlocks && (
            <BulletList editorView={editorView} bottom={bottom} />
          )}
          {supportBlocks && (
            <OrderedList editorView={editorView} bottom={bottom} />
          )}
        </MenuContainer>
