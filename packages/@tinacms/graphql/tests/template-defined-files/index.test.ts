...
describe('Template-Defined Files Mutations', () => {
  describe('Create Document Tests', () => {
    ...
    it('creates single template collection document using collection-specific mutation', async () => {
      ...
      await expect(format(result)).toMatchFileSnapshot('expected-snapshots/create-author-specific-response.json');

      const newDocWrite = bridge.getWrite('authors/john-smith.md');
      expect(newDocWrite).toBeDefined();
      await expect(newDocWrite).toMatchFileSnapshot('expected-snapshots/john-smith-content.md');
    }); */
    ...
    it('creates multi-template collection document with software template', async () => {
      ...
      await expect(format(result)).toMatchFileSnapshot('expected-snapshots/create-product-software-response.json');

      const newDocWrite = bridge.getWrite('products/northwind-crm.md');
      expect(newDocWrite).toBeDefined();
      await expect(newDocWrite).toMatchFileSnapshot('expected-snapshots/northwind-crm-content.md');
    }); */
  });
