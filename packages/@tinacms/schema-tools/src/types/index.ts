...
*/
// Easier to copy this from hardcoded react file than keeping it as a dependency
...
export type StringField<WithNamespace extends boolean = false> = (
...
export type NumberField<WithNamespace extends boolean = false> = (
...
export type BooleanField<WithNamespace extends boolean = false> = (
...
export type DateTimeField<WithNamespace extends boolean = false> = (
...
export type ImageField<WithNamespace extends boolean = false> = (
  | FieldGeneric<string, undefined>
  | FieldGeneric<string, true>
  | FieldGeneric<string, false>
) &
...
export type ReferenceField<WithNamespace extends boolean = false> = (
  | FieldGeneric<string, undefined>
  | FieldGeneric<string, false>
) &
  BaseField<WithNamespace> & {
...
type Field<WithNamespace extends boolean = false> =
  ...
  | NumberField<WithNamespace>
  | BooleanField<WithNamespace>
  | DateTimeField<WithNamespace>
  | ImageField<WithNamespace>
  | ReferenceField<WithNamespace>
...
export interface FieldCollection<WithNamespace extends boolean = false> {
...
export interface TemplateCollection<WithNamespace extends boolean = false> {
  ui?: UICollection
  /**
...
export type Collection<WithNamespace extends boolean = false> = {
  ...
  indexes?: TinaIndex[]
} & (FieldCollection<WithNamespace> | TemplateCollection<WithNamespace>) &
  MaybeNamespace<WithNamespace>
 ...
 * @deprecated
 */
export type TinaFieldBase = SchemaField<false>
/**
 * @deprecated
 */
export type RichTypeInner = RichTextField
/**
 * @deprecated
 */
export type TinaFieldInner<WithNamespace extends boolean> =
  SchemaField<WithNamespace>
/**
 * @deprecated
 */
export type TinaCloudSchemaEnriched = Schema<true>
/**
 * @deprecated
 */
export type TinaCloudSchema<WithNamespace extends boolean> =
  Schema<WithNamespace>
/**
 * @deprecated
 */
export type TinaCloudSchemaBase = Schema
/**
 * @deprecated
 */
...
export type CollectionFieldsWithNamespace<WithNamespace extends boolean> =
  Collection<WithNamespace>
export type CollectionTemplatesWithNamespace<WithNamespace extends boolean> =
  Collection<WithNamespace>
/**
 * @deprecated
 */
 ...
 * @deprecated
 */
export type ReferenceTypeInner = ReferenceField<true>
/**
 * @deprecated
 */
export type ReferenceTypeWithNamespace = ReferenceField<true>
/**
 * @deprecated
 */
export type TinaCloudCollectionEnriched = Collection<true>
/**
 * @deprecated
 */
 ...
 * @deprecated
 */
export type Templateable = Template<true>
/**
 * @deprecated
 */
export type Collectable = Collection<true>
/**
 * @deprecated
 */
 ...
 * @deprecated
 */
export type TinaFieldEnriched = SchemaField<true>

/**
 * @deprecated
 */
export type TinaCloudSchemaConfig = any
