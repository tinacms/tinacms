...
import { Pattern } from '../conversion'

// @Shortcode Support - Ideally we would be able to get rid of stuff like this
export const ShortCodeAdapter = {
  get: getFieldPatterns,
};

function getFieldPatterns(field: RichTextField) {
...
// as top-level.
function hoistAllTemplates(field: RichTextField,
