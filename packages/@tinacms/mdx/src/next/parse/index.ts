// This is the newer MDX parser implementation, introduced in commit 651b6b53b ("Add next module for mdx behavior").
// The public-facing parseMDX in src/parse/index.ts delegates here for MDX content.
