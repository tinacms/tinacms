...
export const Nav = ({
  ...
  return (
    <div
      ...
      {...props}
    >
      <div className="border-b border-gray-200 group w-full px-5 py-3 flex gap-2 justify-between items-center transition-colors duration-150 ease-out">
        ...
        <Menu as="div" className="relative inline-block">
          {({ open }) => (
            <div>
              <Menu.Button
                className={`px-1 transition-all duration-150 ease-out text-gray-400 ${
                  open
              ...
              >
                <FiMoreVertical
                  className={`flex-0 w-6 h-full inline-block fill-current transform `}
                />
              </Menu.Button>
