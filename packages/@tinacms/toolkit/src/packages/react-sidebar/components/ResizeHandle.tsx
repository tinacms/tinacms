...
export const ResizeHandle = () => {
  ...
  return (
    <div
      ...
      className={`z-100 absolute top-1/2 right-px w-2 h-32 bg-white rounded-r-md border border-gray-150 shadow-sm hover:shadow-md origin-left scale-90 hover:scale-100 transition-all duration-150 ease-out transform translate-x-full -translate-y-1/2 group hover:bg-gray-50 ${
