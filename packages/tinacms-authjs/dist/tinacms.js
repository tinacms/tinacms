(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("react"), require("tinacms")) : typeof define === "function" && define.amd ? define(["exports", "react", "tinacms"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global["tinacms-authjs"] = {}, global.NOOP, global.NOOP));
})(this, function(exports2, require$$0, tinacms) {
  "use strict";
  var react = {};
  ...
  (function(exports3) {
    ...
    exports3.SessionContext = void 0;
    exports3.SessionProvider = SessionProvider;
    exports3.getCsrfToken = getCsrfToken;
    exports3.getProviders = getProviders;
    exports3.getSession = getSession;
    exports3.signIn = signIn;
    exports3.signOut = signOut;
    exports3.useSession = useSession;
    var _regenerator = _interopRequireDefault(requireRegenerator());
    var _defineProperty2 = _interopRequireDefault(requireDefineProperty());
    var _asyncToGenerator2 = _interopRequireDefault(requireAsyncToGenerator());
    ...
    exports3.SessionContext = SessionContext;
  ...
  class DefaultAuthJSProvider extends tinacms.AbstractAuthProvider {
    constructor(props) {
      super();
  ...
  exports2.DefaultAuthJSProvider = DefaultAuthJSProvider;
  exports2.TINA_CREDENTIALS_PROVIDER_NAME = TINA_CREDENTIALS_PROVIDER_NAME;
  exports2.TinaUserCollection = TinaUserCollection;
  exports2.UsernamePasswordAuthJSProvider = UsernamePasswordAuthJSProvider;
