...
type BaseComponents = {
  ...
  a?: { url: string; children: React.JSX.Element };
  italic?: { children: React.JSX.Element };
  bold?: { children: React.JSX.Element };
  strikethrough?: { children: React.JSX.Element };
  underline?: { children: React.JSX.Element };
  code?: { children: React.JSX.Element };
  highlight?: { children: React.JSX.Element; color?: string };
  text?: { children: string };
  ul?: { children: React.JSX.Element };
  ol?: { children: React.JSX.Element };
  li?: { children: React.JSX.Element };
  lic?: { children: React.JSX.Element };
  /**
   * @deprecated Use `blockquote` instead. This was incorrectly named and will be removed in a future version.
   */
  block_quote?: { children: React.JSX.Element };
  ...
  hr?: {};
  break?: {};
  maybe_mdx?: { children: React.JSX.Element };
  html?: { value: string };
...
type BaseComponentSignature = {
  [BK in keyof BaseComponents]: (
    props: BaseComponents[BK]
  ) => React.JSX.Element;
};
