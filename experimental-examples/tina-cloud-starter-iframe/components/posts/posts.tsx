      ...
      {data.map((postData) => {
        ...
        return (
          ...
          >
            ...
            >
              <h3
                data-tinafield={tinaField(post, "title")}
              ...
              <div className="flex items-center">
                <div className="flex-shrink-0 mr-2">
                  <img
                    data-tinafield={tinaField(post?.author, "avatar")}
                ...
                <p
                  data-tinafield={tinaField(post?.author, "name")}
                  className="text-sm font-medium text-gray-600 group-hover:text-gray-800 dark:text-gray-200 dark:group-hover:text-white"
                >
                  {post?.author?.name}
                </p>
                {formattedDate !== "" && (
