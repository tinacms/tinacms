...
export const localeQuery = Selector('LocaleInfo')({
  au: localeItems,
  gb: localeItems,
  us: localeItems,
})

export type LocaleType = Response<'LocaleInfo', typeof localeQuery>

export const LocaleContext = createContext<LocaleType['au']>(null)
