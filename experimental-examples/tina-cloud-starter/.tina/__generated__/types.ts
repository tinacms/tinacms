...
export type LayoutQueryFragmentFragment = {
  __typename?: "Query";
  getGlobalDocument: {
    __typename?: "GlobalDocument";
    data: {
...
export function getSdk<C>(requester: Requester<C>) {
  return {
    PageQuery(
      ...
      >(PageQueryDocument, variables, options);
    },
    ContentQuery(
      ...
      >(ContentQueryDocument, variables, options);
    },
    BlogPostQuery(
      ...
      return requester<
        ...
        BlogPostQueryQueryVariables
      >(BlogPostQueryDocument, variables, options);
    },
    getPostsDocument(
