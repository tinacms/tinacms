/**
 * Home page tests for the Astro kitchen-sink example app.
 *
 * Validates that the home page loads successfully and renders
...
test.describe('Home Page', () => {
  ...
  test('should load without errors', async ({ page }) => {
    ...
    await expect(page.locator('text=No blocks to display')).not.toBeVisible();
  });
