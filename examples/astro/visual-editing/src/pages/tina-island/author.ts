...
export const GET: APIRoute = async ({ request, url }) => {
  ...
  return new Response(`<section class="max-w-3xl mx-auto px-6 sm:px-8 py-16" data-tina-island="/tina-island/author?filename=${encodeURIComponent(filename)}">${html}</section>`, {
