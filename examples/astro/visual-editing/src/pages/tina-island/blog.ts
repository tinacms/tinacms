...
export const ALL: APIRoute = async ({ request, url }) => {
  ...
  return new Response(`<article class="max-w-3xl mx-auto px-6 sm:px-8 py-16" data-tina-island="/tina-island/blog?filename=${encodeURIComponent(filename)}">${html}</article>`, {
