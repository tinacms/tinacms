...
export type GetCollectionsQuery = {
  __typename?: "Query";
  getCollections: Array<{ __typename?: "Collection"; name: string }>;
};

export type GetPostsDocumentPartsTestFragment = {
  __typename?: "PostsDocument";
  form: any;
};
...
type QueryMap = {
  ...
  post: GetPostsDocumentQuery["getPostsDocument"];
};
...
export type GetAuthorsDocumentQuery = {
  ...
  getAuthorsDocument: {
    __typename?: "AuthorsDocument";
    data: { __typename?: "Authors"; name: string; avatar?: Maybe<string> };
  };
};
...
export const GetPagesListDocument = gql`
  ...
  ${PagesPartsFragmentDoc}
`;
import postqueryJSON2 from "../../temp-post-ast.json";
import postqueryJSON from "../../temp-post-author-ast.json";
...
export function getSdk<C>(requester: Requester<C>) {
  return {
    ...
    // },
    async getPostsDocument<Include extends { [key: string]: boolean }>(
      variables: GetPostsDocumentQueryVariables,
      options?: Include
    ): Promise<{
      data: GetPostsDocumentQuery & {
        getPostsDocument: {
          data: GetPostsDocumentQuery["getPostsDocument"]["data"] & {
            [k in keyof Include]: QueryMap[k];
          };
        };
      };
      variables: GetPostsDocumentQueryVariables;
      ...
      // const includes = Object.keys(options.include);
      // console.log("get it", includes);
      ...
      return {
        ...result,
        query: print(postqueryJSON),
        data: {
          ...result.data,
          getPostsDocument: {
            ...result.data.getPostsDocument,
            data: {
              ...result.data.getPostsDocument.data,
              author: (
                await requester(GetAuthorsDocumentDocument, {
                  relativePath: "napolean.md",
                })
              ).data.getAuthorsDocument,
            },
          },
        },
      };
