...
export type TestQuery = { __typename?: 'Query', getCollections: Array<{ __typename?: 'Collection', name: string }> };
...
export function getSdk<C>(requester: Requester<C>) {
  return {
    Test(variables?: TestQueryVariables, options?: C): Promise<TestQuery> {
      return requester<TestQuery, TestQueryVariables>(TestDocument, variables, options);
    }
  };
}
