    ...
    <PageSection title='Documentation'>
      <div className='space-y-6'>
        {docs.map((doc) => (
          ...
          >
            <h2 className='text-2xl font-semibold text-gray-700 dark:text-white group-hover:text-theme-600 dark:group-hover:text-theme-300 transition-all duration-150 title-font'>
