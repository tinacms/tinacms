...
const router = ({ document, collection }: any) =>
  `/${collection.name}/${document._sys.filename}`;
    ...
    collections: [
                    ...
                    fields: [
                      ...
                      },
                      {
                        ...
                        options: [
                          ...
                          { value: 'music', label: 'Trending Music' },
                          { value: 'art', label: 'Art' },
                        ],
                      },
                      {
      ...
      },
      {
        ...
        ui: {
          ...
          filename: { slugify, readonly: true },
        },
        fields: [
          { type: 'string', name: 'title', required: true, isTitle: true },
          { type: 'reference', name: 'author', collections: ['author'] },
          {
            type: 'string',
            list: true,
            name: 'categories',
