  ...
  return (
    <div className='w-full flex justify-end p-3'>
      <button
        ...
        className='inline-flex items-center rounded border border-transparent bg-indigo-100 px-3 py-2 text-sm font-medium leading-4 text-indigo-700 hover:bg-indigo-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2'
      >
        Nav
      </button>
